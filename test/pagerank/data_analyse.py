...
with open('output.csv', 'w') as csvfile:
    ...
    for line in data:
        ...
        time_sum += float(time)
        waitiotm_sum += float(waitiotm)
        waitcomptm_sum += float(waitcomptm)
        
print("CSV 文件写入完成")
avg_time = time_sum / total_lines
avg_waitiotm = waitiotm_sum / total_lines
avg_waitcomptm = waitcomptm_sum / total_lines
print("avg time:", avg_time)
print("avg waitiotm:", avg_waitiotm)
print("avg waitcomptm:", avg_waitcomptm)