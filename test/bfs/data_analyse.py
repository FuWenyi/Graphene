...
with open('output.csv', 'w') as csvfile:
    ...
    # 写入标题行
    writer.writerow(['level', 'frontier num', 'level tm', 'convert tm', 'io tm', 'io submit tm', 'io poll tm', 'wait io tm', 'wait comp tm', 'iosize', 'comp tm end', 'io submit', 'io submit num', 'io getevent', 'use iosize'])
    ...
    for line in data:
        ...
        writer.writerow([level, fron, time, converttm, iotm, io_sub_tm, io_poll_tm, waitiotm, waitcomptm, iosize, compend, sub, sub_num, getevents, useiosize])
